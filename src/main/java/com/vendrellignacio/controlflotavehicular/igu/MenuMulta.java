...
public class MenuMulta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tablaMul = new javax.swing.JTable();
        ...
        tablaMul.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        tablaMul.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        jScrollPane1.setViewportView(tablaMul);
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        AltaMulta alta = new AltaMulta(control);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        if (tablaMul.getRowCount()>0){
            //verifico si se seleccionó una celda
            if (tablaMul.getSelectedRow()!=-1){
                /*//obtengo el valor de una columna q fue seleccionada*/
                int idMul = Integer.parseInt(String.valueOf(tablaMul.getValueAt(tablaMul.getSelectedRow(),0)));
                //MOSTRAMOS la pantala para modificar
                ModificarMul pantallaModificar = new ModificarMul (idMul,control);
    ...
    private javax.swing.JTable tablaMul;
    ...
    private void cargarTabla() {
        ...
        String titulos[] = {"Id", "Insfracción", "Importe", "Pagado", "Estado", "Id Viaje"};
        model.setColumnIdentifiers(titulos);
        tablaMul.setModel(model);
        
        //traer los registros desde la bd
        List <Multa> listaMul = control.traerMultas();
        if (listaMul != null){
            for (Multa mul : listaMul){
                Object[] obj = {mul.getId_multa(), mul.getInfraccion(), mul.getImporte(), mul.getImpPagado(), 
                    mul.getEstado(), mul.getUnViaje().getId_viaje()};
