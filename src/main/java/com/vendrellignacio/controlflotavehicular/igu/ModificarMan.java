...
public class ModificarMan extends javax.swing.JFrame {

    Controladora control;
    int idMan;
    Mantenimiento man;
    public ModificarMan(int idMan, Controladora control) {
        initComponents();
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (idPat == null){
            ...
            control.editarMantenimiento(man, patente, km, fecha, observaciones);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        man = control.traerMan(idMan);
        txtKm.setText(String.valueOf(man.getKm()));
        dcFecha.setDate(man.getFecha());
        txtObs.setText(man.getObsv());
        txtPatente.setText(man.getUnPatente().getCodigoPatente());
