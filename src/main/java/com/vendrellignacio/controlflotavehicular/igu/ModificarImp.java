...
public class ModificarImp extends javax.swing.JFrame {

    Controladora control;
    Impuesto imp;
    int idImp;
    public ModificarImp(int idImp, Controladora control) {
        initComponents();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        imp = control.traerImp(idImp);
        txtAno.setText(String.valueOf(imp.getAno()));
        dcFechaPago.setDate(imp.getFechaPago());
        txtPatente.setText(imp.getUnPatente().getCodigoPatente());
