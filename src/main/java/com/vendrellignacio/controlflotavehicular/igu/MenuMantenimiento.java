...
public class MenuMantenimiento extends javax.swing.JFrame {
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        AltaMantenimiento alta = new AltaMantenimiento(control);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        if (tablaMan.getRowCount()>0){
            ...
            if (tablaMan.getSelectedRow()!=-1){
                ...
                int idMan = Integer.parseInt(String.valueOf(tablaMan.getValueAt(tablaMan.getSelectedRow(),0)));
                //MOSTRAMOS la pantala para modificar
                ModificarMan pantallaModificar = new ModificarMan (idMan,control);
