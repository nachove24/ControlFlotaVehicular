...
public class MenuTecnica extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tablaTec.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        btnCrear.setText("Registrar Tecnica");
        ...
        btnEditar.setText("Editar Tecnica");
        ...
        btnBorrar.setText("Borrar Tecnica");
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        AltaTecnica alta = new AltaTecnica(control);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        if (tablaTec.getRowCount()>0){
            //verifico si se seleccionó una celda
            if (tablaTec.getSelectedRow()!=-1){
                /*//obtengo el valor de una columna q fue seleccionada*/
                int idTec = Integer.parseInt(String.valueOf(tablaTec.getValueAt(tablaTec.getSelectedRow(),0)));
                //MOSTRAMOS la pantala para modificar
                ModificarTec pantallaModificar = new ModificarTec (idTec,control);
    ...
    private void cargarTabla() {
        ...
        String titulos[] = {"Id", "Vencimiento VTV", "Año","Patente"};
